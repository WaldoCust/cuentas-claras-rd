    ...
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden premium-gradient-bg">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 text-sm font-bold uppercase tracking-widest">Finanzas y Cumplimiento de Élite</p>
        </div>
        ...
        <div className="glass-card rounded-[2.5rem] p-8 md:p-12 border-white/60 bg-white/70 shadow-2xl shadow-slate-200/40">
          ...
          <div className="mt-10 pt-8 border-t border-slate-100 text-center">
            <p className="text-xs text-slate-400 mb-4 font-bold uppercase tracking-tight">¿Aún no tienes acceso?</p>
            <Link 
              href="/signup"
              className="text-sm font-black text-primary hover:underline transition-all uppercase tracking-widest"
            >
              Regístrate Ahora
            </Link>
          </div>
