...
export default function ClientEmptyState({ type = "empty", onAction, actionLabel }) {
  const configs = {
    empty: {
      icon: Users,
      title: "Sin clientes en cartera",
      message: "Tu directorio fiscal está vacío. Comienza registrando a tus clientes habituales para agilizar tu facturación.",
      buttonIcon: UserPlus
    },
    search: {
      icon: SearchX,
      title: "Sin resultados de búsqueda",
      message: "No hemos encontrado registros que coincidan con los criterios aplicados. Prueba con otro RNC o Nombre.",
      buttonIcon: null
    }
  };
